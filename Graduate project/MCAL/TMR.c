  ...
  */
  if(motor == MOTOR1)
  {
    if(channel == 1)
    {
      ...
      TIM5->CCR1 = (((PERIOD_TICKS + 1)*speed)/100);
    }
    else
    {
      // channel 1 off
      ...
      TIM5->CCR2 = (((PERIOD_TICKS + 1)*speed)/100);
    }
  ...
  else if(motor == MOTOR2)
  {
    if(channel == 1)
    {
      ...
      TIM3->CCR4 = 0;
      //channel 1 on with speed
      TIM3->CCR3 = (((PERIOD_TICKS + 1)*speed)/100); 
    }
    else
    {
      //channel 1 off
      TIM3->CCR3 = 0;
      //channel 2 on with speed
      TIM3->CCR4 = (((PERIOD_TICKS + 1)*speed)/100);
    }
  ...
  else if(motor == MOTOR3)
  {
    if(channel == 1)
    {
      ...
      TIM4->CCR2 = 0;
      //channel 1 on with speed
      TIM4->CCR1 = (((PERIOD_TICKS + 1)*speed)/100);
    }
    else
    {
      // channel 1 off
      TIM4->CCR1 = 0;
      //channel 2 on with speed
      TIM4->CCR2 = (((PERIOD_TICKS + 1)*speed)/100);
    }
